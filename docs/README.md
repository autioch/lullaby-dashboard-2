...
| [features/](features/)                             | Per-feature specs — see [`_TEMPLATE_spec.md`](features/_TEMPLATE_spec.md) and [`README.md`](features/README.md) |

## Reading order by task

- **Feature planning** — `01`, `04`, `05`, `07`, plus `03` and `06` for context; write the spec from `features/_TEMPLATE_spec.md`.
